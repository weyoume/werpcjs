/**
 * @file JSONRPC 2.0 request authentication with Ezira authorities.
 * @author Lopu <lopu@lopudesigns.com>
 */

import {hexify, PrivateKey} from 'ezcrypt.js'
import {createHash, randomBytes} from 'crypto'

/**
 * Signing constant used to reserve opcode space and prevent cross-protocol attacks.
 * Output of `sha256('ezira_jsonrpc_auth')`.
 */
 ...
 * @param account    Ezira account name that is the signer.
 ...
 *
 * Responsible for:
 *   1. Account must be a valid Ezira blockchain account
